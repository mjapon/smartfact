...
public class NewPersonaFrame extends BaseFrame {
    ...
    private ClientesFrame parentFrame;
     ...
     */
    public NewPersonaFrame(ClientesFrame parent, Integer tipo) {
        initComponents();
        ...
        String titulo = "";
        switch(tipo){
            case 1: {titulo="Registrar Cliente"; jRBCliente.setSelected(true); break;}
            case 2: {titulo="Registrar Proveedor";jRBProveedor.setSelected(true);  break;}
